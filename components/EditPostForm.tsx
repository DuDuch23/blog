...
import { editPost } from "@/app/actions/post";
...
export default function EditPostForm({ post }: Props) {
  ...
  const [content, setContent] = useState(post.wysiwygContent);
  ...
  async function handleSubmit(e: { preventDefault(): void }) {
    ...
    setError("");
    try {
      await editPost({ id: post.id, title, wysiwygContent: content, image });
    } catch {
